...
<?php
 ...
 if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  $attend = $_POST['attend'];
  $insertAtten = $school->insertAttendence($cur_date, $attend);
}
      ...
      <div class="panel-body">
        ...
        <div class="col-sm-12">
          <div class="well text-center" style="color: red; font-size: 20px">
            ...
            <a class="btn btn-info pull-right" href="date_view.php" style="margin-top: px">View All</a>
          </div>
         <form action="" method="POST">
          <div class="form-group">
           ...
           <tbody>
              <?php
                $school = new School();
                $studentdata = $school->getStudentData();
                if ($studentdata) {
                  $i = 0;
